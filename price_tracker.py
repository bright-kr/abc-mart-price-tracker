"""
ABC-MART Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from ABC-MART.

Docs  : https://docs.brightdata.co.kr/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.co.kr/products/insights/price-tracker/abc-mart
"""
...
# Set your Web Scraper ID after building your ABC-MART scraper:
# https://brightdata.co.kr/products/web-scraper/abc-mart
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your ABC-MART scraper at: https://brightdata.co.kr/products/web-scraper/abc-mart\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of ABC-MART product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover ABC-MART products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a ABC-MART category page.

    Example:
        results = discover_by_category("https://abc-mart.net/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.abc-mart.net/en/products/sample-product-123456",
        # Add more ABC-MART product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "abc-mart_prices.json"
    ...
    # cat_results = discover_by_category("https://abc-mart.net/category/sample", limit=50)
